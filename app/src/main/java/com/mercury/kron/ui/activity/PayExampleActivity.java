...
import com.cloudipsp.android.BuildConfig;
...
public class PayExampleActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardInput.setCompletionListener(new CardInputView.CompletionListener() {
            ...
            public void onCompleted(CardInputView view) {
                Toast.makeText(PayExampleActivity.this, "onCompleted", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            if (card != null) {
                ...
                cloudipsp.pay(card, order, new Cloudipsp.PayCallback() {
                    ...
                    public void onPaidProcessed(Receipt receipt) {
                        Toast.makeText(PayExampleActivity.this, "Paid " + receipt.status.name() + "\nPaymentId:" + receipt.paymentId, Toast.LENGTH_LONG).show();
                    }
                    ...
                    public void onPaidFailure(Cloudipsp.Exception e) {
                        if (e instanceof Cloudipsp.Exception.Failure) {
                            ...
                            Toast.makeText(PayExampleActivity.this, "Failure\nErrorCode: " +
                                    f.errorCode + "\nMessage: " + f.getMessage() + "\nRequestId: " + f.requestId, Toast.LENGTH_LONG).show();
                        } else if (e instanceof Cloudipsp.Exception.NetworkSecurity) {
                            Toast.makeText(PayExampleActivity.this, "Network security error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        } else if (e instanceof Cloudipsp.Exception.ServerInternalError) {
                            Toast.makeText(PayExampleActivity.this, "Internal server error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        } else if (e instanceof Cloudipsp.Exception.NetworkAccess) {
                            Toast.makeText(PayExampleActivity.this, "Network error", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(PayExampleActivity.this, "Payment Failed", Toast.LENGTH_LONG).show();
                        }
                        e.printStackTrace();
                    }
                });
