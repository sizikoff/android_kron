 ...
 */
public class LoginPartnerActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
        ...
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if(!isChecked){
                    ...
                    Intent intent = new Intent(LoginPartnerActivity.this,MainActivity.class);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginPartnerActivity.this,
                        android.R.layout.simple_dropdown_item_1line, emailAddressCollection);

        mEmailView.setAdapter(adapter);
    }

    public void onClickClearMail(View view) {
     //TODO set clear
    }

    public void onClickVisablePassword(View view) {
      //TODO set visiable
    }
